                        ...
                        <tbody>
                            {/* row 1 */}
                            {
                                toys.map((toy, index) => <tr>
                                    ...
                                    <td>{toy.sold}</td>
                                    <td>
                                        <Link to={`/dashboard/update-toy/${toy._id}`} className="btn rounded p-6 text-white bg-[#d1a054] mr-6"><HiPencilAlt size={24} /></Link>
                                        <button onClick={() => handleDelete(toy._id)} className="btn p-6 text-white bg-red-600 "><MdDeleteOutline size={24} /></button>
                                    </td>
